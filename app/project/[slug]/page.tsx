...
export default function ProjectDetailPage() {
    ...
    const projectData: ProjectType[] = [
            ...
            githubUrl: [
                {
                    ...
                    link: "https://github.com/NotHamxa/volt"
                }
            ]
        },
        {
            ...
            githubUrl: [
                {
                    ...
                    link: "https://github.com/NotHamxa/EpsilonFrontendReact"
                },
                {
                    name: "Epsilon Admin Panel(Desktop)",
                    link: "https://github.com/NotHamxa/EpsilonAdminPanelElectron"
                },
                {
                    name: "Epsilon Admin Panel(Mobile)",
        ...
        },
        {
            ...
            githubUrl: [
                {
                    name: "Discord Bot",
                    link: "https://github.com/NotHamxa/RDLN_Discord_Bot"
                }
            ]
        },
        {
    ...
    const handleGithubClick = () => {
        ...
        if (githubUrl.length === 1) {
            // Single repo - open directly
            window.open(githubUrl[0].link, '_blank', 'noopener,noreferrer')
        } else {
            // Multiple repos - show modal
    ...
    return (
        <>
            ...
            <GithubModal
                ...
                setVisible={setGithubModalOpen}
                repos={githubUrl || []}
            />

            {/* Floating Header */}
            <div
                className={`fixed left-0 right-0 top-0 z-50 px-4 sm:px-6 lg:px-8 pt-4 transition-all duration-500 ease-out ${
                    showStickyHeader
                ...
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 lg:py-24">
                    <div className="space-y-16 lg:space-y-24">
                        {blocks.map((block, idx) => {
                            ...
                            // Image Block (Full Width) - Smart aspect ratio handling
                            if (block.type === "img") {
                                return (
                                    <div
                                        key={idx}
                            ...
                            // Image + Text Side by Side - Better image handling
                            if (block.type === "imgText") {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                className={`relative rounded-2xl overflow-hidden border border-border shadow-xl bg-card/50 backdrop-blur-sm flex items-center justify-center p-6 ${
